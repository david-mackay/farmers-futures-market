...
exports.createVouchersRouter = createVouchersRouter;
const express_1 = require("express");
const auth_1 = require("../middleware/auth");
const orderService = __importStar(require("../services/order-service"));
function createVouchersRouter(io) {
    ...
    router.post('/:id/list', auth_1.requireAuth, (req, res) => {
    ...
    router.post('/:id/buy', auth_1.requireAuth, (req, res) => {
