...
exports.getPlantRecommendations = getPlantRecommendations;
exports.getHedgeFlowCalc = getHedgeFlowCalc;
...
function getPlantRecommendations() {
  ...
  `).all();
    return rows
        ...
        .map(row => {
        const yieldPerAcre = constants_1.CROP_YIELD_PER_ACRE[row.crop_type] || 0;
...
function getHedgeFlowCalc(cropType, acreage) {
    const yieldPerAcre = constants_1.CROP_YIELD_PER_ACRE[cropType] || 0;
